...
<body>
	<div class="moldura">
		<h3><i class="fa fa-graduation-cap"></i><strong>Estude</strong>Em<strong>Casa</strong></h3>
		<H1 class="titulo">Certificado</H1>

		<p>Certificamos que</p>
		<h4>{{strtoupper($usuario->name)}}</h4>
		<p>participou do curso {{strtoupper($curso->nome)}}, por meio da plataforma EstudeEmCasa.</p>
